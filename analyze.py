    ...
    def _compute_sycophancy(self, run_ids: list[str]) -> pd.DataFrame:
        ...
        return self._q(
            ...
            SELECT
                ...
                ROUND(AVG(CAST(triage_changed AS FLOAT64)), 4) AS triage_change_rate_corrective,
                ROUND(AVG(CAST(triage_changed_3a AS FLOAT64)), 4) AS triage_change_rate_3a,
                ROUND(AVG(CAST(triage_changed_3b AS FLOAT64)), 4) AS triage_change_rate_3b,
                ROUND(AVG(CAST(triage_changed_3c AS FLOAT64)), 4) AS triage_change_rate_3c,
